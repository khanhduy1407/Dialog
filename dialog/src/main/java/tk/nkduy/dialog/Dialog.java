...
public class Dialog {
    ...
    /**
     * Dialog base layout root view
     */
    private final ViewGroup rootView;

    /**
     * Dialog content container which is a different layout rather than base layout
     */
     ...
     */
    public static DialogBuilder newDialog(@NonNull Context context) {
        ...
        if (adapter != null && holder instanceof HolderAdapter) {
            ...
            holderAdapter.setOnItemClickListener(new OnHolderListener() {
                @Override public void onItemClick(@NonNull Object item, @NonNull View view, int position) {
                    ...
                    onItemClickListener.onItemClick(Dialog.this, item, view, position);
                }
            });
        }
        return view;
    ...
    private void setClickListener(View view) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ...
                onClickListener.onClick(Dialog.this, v);
            }
        });
    }
                    ...
                    case KeyEvent.ACTION_UP:
                        if (keyCode == KeyEvent.KEYCODE_BACK) {
                            if (onBackPressListener != null) {
                                onBackPressListener.onBackPressed(Dialog.this);
                            }
                            if (isCancelable) {
                                onBackPressed(Dialog.this);
                            }
                            return true;
                        }
                        break;
     ...
     */
    public void onBackPressed(@NonNull Dialog dialog) {
        if (onCancelListener != null) {
            onCancelListener.onCancel(Dialog.this);
        }
        dismiss();
    }
